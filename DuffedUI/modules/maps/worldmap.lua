...
function WorldMap:Skin()
	...
	--[[QuestScrollFrame:CreateBackdrop()
	QuestScrollFrame.backdrop:ClearAllPoints()
	QuestScrollFrame.backdrop:SetTemplate("Transparent")
	QuestScrollFrame.backdrop:Size(309, 480)
	QuestScrollFrame.backdrop:SetPoint("LEFT", Map.backdrop, "RIGHT", 2, 0)]]

...
local Update = function(self)
	...
	if (Total > 0) then
		self.Text:SetText(format("%s: %s%%", D.PanelColor .. L.DataText.Armor .. "|r", DataText.ValueColor .. floor(L.DataText.Slots[1][3] * 100) .. "|r"))
	else
		self.Text:SetText(format("%s: %s%%", D.PanelColor .. L.DataText.Armor .. "|r", DataText.ValueColor .. "100" .. "|r"))
	end

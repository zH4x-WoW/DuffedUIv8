...
DuffedUIBar3Button:SetScript("OnClick", function(self, btn)
	if btn == "RightButton" then
		...
		if C["actionbar"].LeftSideBarDisable == true then
			return UIErrorsFrame:AddMessage("Left Sidebars are disabled!", 1.0, 0.0, 0.0, 53, 5) end 
...
if C["actionbar"].RightSideBarDisable then return UIErrorsFrame:AddMessage("Right Sidebars are disabled!", 1.0, 0.0, 0.0, 53, 5) end
if not C["actionbar"].Rightsidebars then UpdateBar(self, DuffedUIBar4) end end)

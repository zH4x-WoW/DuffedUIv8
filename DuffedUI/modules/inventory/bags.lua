...
----> Add bank slot border color according to quality
----> Add quest item border color yellow
----> Add a way to identify new items in bags
...
function Bags:CreateReagentContainer()
	...
	if C["chat"].lBackground then Reagent:SetPoint("BOTTOMLEFT", LeftChatBackground, "TOPLEFT", 0, 6) else Reagent:SetPoint("BOTTOMLEFT", DataTextLeft, "TOPLEFT", 0, 6) end
...
function Bags:Enable()
	...
	if C["chat"].rBackground then self:CreateContainer("Bag", "BOTTOMRIGHT", RightChatBackground, "TOPRIGHT", 0, 6) else self:CreateContainer("Bag", "BOTTOMRIGHT", DataTextRight, "TOPRIGHT", 0, 6) end
	if C["chat"].lBackground then self:CreateContainer("Bank", "BOTTOMLEFT", LeftChatBackground, "TOPLEFT", 0, 6) else self:CreateContainer("Bank", "BOTTOMLEFT", DataTextLeft, "TOPLEFT", 0, 6) end
	self:HideBlizzard()

...
local function LoadSkin()
	...
	TradeHighlightPlayerTop:SetColorTexture(0, 1, 0, .2)
	TradeHighlightPlayerBottom:SetColorTexture(0, 1, 0, .2)
	TradeHighlightPlayerMiddle:SetColorTexture(0, 1, 0, .2)
	TradeHighlightPlayer:SetFrameStrata('HIGH')
	TradeHighlightPlayer:Point('TOPLEFT', TradeFrame, 'TOPLEFT', 11, -86)

	TradeHighlightPlayerEnchantTop:SetColorTexture(0, 1, 0, .2)
	TradeHighlightPlayerEnchantBottom:SetColorTexture(0, 1, 0, .2)
	TradeHighlightPlayerEnchantMiddle:SetColorTexture(0, 1, 0, .2)
	TradeHighlightPlayerEnchant:SetFrameStrata('HIGH')

	TradeHighlightRecipientTop:SetColorTexture(0, 1, 0, .2)
	TradeHighlightRecipientBottom:SetColorTexture(0, 1, 0, .2)
	TradeHighlightRecipientMiddle:SetColorTexture(0, 1, 0, .2)
	TradeHighlightRecipient:SetFrameStrata('HIGH')
	TradeHighlightRecipient:Point('TOPLEFT', TradeFrame, 'TOPLEFT', 179, -86)

	TradeHighlightRecipientEnchantTop:SetColorTexture(0, 1, 0, .2)
	TradeHighlightRecipientEnchantBottom:SetColorTexture(0, 1, 0, .2)
	TradeHighlightRecipientEnchantMiddle:SetColorTexture(0, 1, 0, .2)

...
DuffedUIBar1:SetClampedToScreen(true)
DuffedUIBar1:SetMovable(true)
DuffedUIBar1.text = D.SetFontString(DuffedUIBar1, C["media"].font, 12)
DuffedUIBar1.text:SetPoint("CENTER")
DuffedUIBar1.text:SetText("Move Bar1")
tinsert(D.AllowFrameMoving, DuffedUIBar1)
...
DuffedUIBar2.text = D.SetFontString(DuffedUIBar2, C["media"].font, 12)

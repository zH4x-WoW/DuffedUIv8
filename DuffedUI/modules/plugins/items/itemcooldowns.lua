...
if C["plugins"].ItemCooldowns ~= true then return end
...
dicd:SetBackdropBorderColor(unpack(C["medias"].BorderColor))
dicd:SetBackdropColor(unpack(C["medias"].BackdropColor))

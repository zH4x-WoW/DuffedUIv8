...
SpellBinder.title:SetText(L.Plugins.Click2CastTitle)
...
SpellBinder.backdrop = CreateFrame("Frame", nil, SpellBinder)
SpellBinder.backdrop:SetTemplate("Transparent")
SpellBinder.backdrop:Point("TOPLEFT", -18, 0)
SpellBinder.backdrop:Point("BOTTOMRIGHT", 0, 9)
SpellBinder.backdrop:SetFrameStrata("BACKGROUND")
SpellBinder.backdrop:SetFrameLevel(1)
...
SpellBinder.OpenButton.backdrop = CreateFrame("Frame", nil, SpellBinder.OpenButton)
SpellBinder.OpenButton.backdrop:SetTemplate("Transparent")
SpellBinder.OpenButton.backdrop:SetAllPoints()
SpellBinder.OpenButton.backdrop:SetFrameStrata("BACKGROUND")
SpellBinder.OpenButton.backdrop:SetFrameLevel(1)

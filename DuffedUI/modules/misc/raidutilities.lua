...
anchor.text:SetFont(C["media"].font, 12)
...
local function CreateButton(name, parent, template, width, height, point, relativeto, point2, xOfs, yOfs, text)
	...
	if text then
		...
		b.t:SetFont(C["media"].font, 12, "THINOUTLINE")
...
CreateButton("RaidUtilityShowButton", UIParent, "UIPanelButtonTemplate, SecureHandlerClickTemplate", RaidUtilityPanel:GetWidth() / 1.5, 18, "TOP", RaidUtilityPanel, "TOP", 0, 0, RAID_CONTROL)
...
CreateButton("RaidUtilityDisbandButton", RaidUtilityPanel, "UIPanelButtonTemplate", RaidUtilityPanel:GetWidth() * 0.8, 18, "TOP", RaidUtilityPanel, "TOP", 0, -5, L.disband)

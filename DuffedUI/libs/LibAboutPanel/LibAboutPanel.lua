...
local fields = { "Version", "Author", "X-Category", "X-License", "X-Email", "Email", "eMail", "X-Website", "X-Discord", "X-Credits", "X-Localizations", "X-BugReport", "X-Tester" }

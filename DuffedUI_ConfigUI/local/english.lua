...
DuffedUIConfigUILocalization.datatextorderhall = "Orderhall position (0 for disabled)"DuffedUIConfigUILocalization.datatextquickjoin = "QuickJoin position (0 for disabled)"DuffedUIConfigUILocalization.datatexttime24 = "Enable 24h time"
